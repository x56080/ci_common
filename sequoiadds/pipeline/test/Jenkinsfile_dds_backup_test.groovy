        ...
        stage('exec test') {
            steps {
                ...
                script{
                    ...
                    execpara += " -DddsPackagePath=\"http://192.168.29.80:8080/view/daily_dds/job/${DDS_PROJECT_NAME}/lastSuccessfulBuild/artifact/dds/release/sequoiadb-dds-${dds_version}-linux_${host_arch}-installer.run\""
