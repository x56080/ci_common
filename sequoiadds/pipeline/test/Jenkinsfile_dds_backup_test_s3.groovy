        ...
        stage('exec test') {
            steps {
                ...
                script{
                    ...
                    execpara += " -DddsPackagePath=\"http://192.168.29.80:8080/view/daily_dds/job/${DDS_PROJECT_NAME}/lastSuccessfulBuild/artifact/build_run_dds/release/sequoiadb-dds-${dds_version}-linux_${host_arch}-installer.run\""
                    ...
                    execpara += " -DtestCaseStorageType=\"s3\""
                    execpara += " -DminioEndpointUrl=\"${minio_endpoint_url}\""
                    execpara += " -DminioAccessKeyId=\"${minio_access_key_id}\""
                    execpara += " -DminioSecretAccessKey=\"${minio_secret_access_key}\""
                    execpara += " -DminioRegion=\"${minio_region}\""
